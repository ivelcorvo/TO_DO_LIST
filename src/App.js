  ...
  return (
    <div className="bg-gray-200 text-gray-200 flex flex-col min-h-screen p-0 m-0">
      ...
      <div className={`grid flex-grow ${(user)?"grid-cols-1":"grid-cols-1 md:grid-cols-3"} rounded-md`}>       
        <div className={`rounded-md ${(user)?"col-span-1":"col-span-2"} px-3 flex flex-col h-screen`}>
          <div className="h-full">
            <div className="max-w-150 bg-gray-300 rounded-2xl shadow-md p-3 mx-auto mt-30">
              <BrowserRouter>            
                <Routes>
        ...
        {!user &&
          <div className="col-span-1 h-full">
            <section className="bg-gray-300 h-full text-gray-600 py-20 px-10 shadow-md">
              ...
              <br />
              <p>Desenvolvido para demostrar demonstrar mnhas habilidades em desenvolvimento front-end , consumo de APIs em tempo real e criação de aplicações interativas com autenticação segura.</p>
            </section>
          </div>
        }
      </div>
